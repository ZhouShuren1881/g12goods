...
import cn.edu.xmu.oomall.order.discount.impl.PriceCouponDiscount;
import cn.edu.xmu.oomall.order.discount.impl.PriceCouponLimitation;
...
public class BaseCouponDiscountTest {
	...
	public void getInstanceTest() throws JsonProcessingException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
		...
		Assert.assertEquals(("{\"value\":1,\"className\":\"cn.edu.xmu.oomall.order.discount.impl.PriceCouponDiscount\",\"couponLimitation\":{\"value\":10,\"className\":\"cn.edu.xmu.oomall.order." +
