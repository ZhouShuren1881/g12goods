...
//    }
      ...
      public SpuBo(GoodsSpuPo             po,
            ...
            this();
            this.copyFromPo(po);
            this.brand =      brand == null ? BrandOverview.newNull() : new BrandOverview(brand);
            this.category =   category == null ? new IdNameOverview(0L, null) : new IdNameOverview(category.getId(), category.getName());
